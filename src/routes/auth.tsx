  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 grid place-items-center py-6 px-4 relative">
        ...
        <div className="w-full max-w-md bg-card rounded-xl shadow-lg border border-border/40 p-5 z-10">
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 w-full inline-flex items-center justify-center gap-1.5 rounded-lg bg-primary-dark hover:bg-primary text-white px-3 py-2 text-xs font-bold transition-all duration-300 shadow hover:shadow-md disabled:opacity-60 cursor-pointer"
            >
              {loading ? (
    ...
    <div className="block">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full rounded-lg border border-input bg-white px-2.5 py-1.8 outline-none focus:ring-2 focus:ring-primary text-xs transition-all ${Icon ? "pl-8" : ""}`}
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="block">
      ...
      <select
        ...
        className="w-full rounded-lg border border-input bg-white px-2.5 py-1.8 outline-none focus:ring-2 focus:ring-primary text-xs disabled:bg-muted/70 disabled:cursor-not-allowed transition-all"
      >
        {options.map((o) => (
